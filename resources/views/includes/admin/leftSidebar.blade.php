            ...
            <ul id="sidebarnav">
                ...
                <li>
                    ...
                    <div class="user-profile dropdown m-t-20">
                        <div class="user-content hide-menu m-t-10">
                            <h5 class="m-b-10 user-name font-medium">{!! Auth::user()->firstName.' '.Auth::user()->lastName  !!}</h5>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)"
                       aria-expanded="false">
                        ...
                        <span class="hide-menu">Competitions Settings</span>
                    </a>
                    <ul aria-expanded="false" class="collapse  first-level">
                        <li class="sidebar-item">
                            <a href="javascript:void(0)" class="sidebar-link has-arrow">
                                <i class="icon-Record"></i>
                                <span class="hide-menu">Competition</span>
                            </a>
                            <ul class="collapse second-level" aria-expanded="false">
                                <li class="sidebar-item">
                                    <a href="{!! route('competition.create') !!}" class="sidebar-link">
                                        <i class="mdi mdi-octagram"></i>
                                        <span class="hide-menu">New Competition</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="{!! route('competition.index') !!}" class="sidebar-link">
                                        <i class="mdi mdi-octagram"></i>
                                        <span class="hide-menu">Show all Competitions</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="sidebar-item">
                            ...
                            <ul class="collapse second-level" aria-expanded="false">
                                <li class="sidebar-item">
                                    <a href="{!! route('milestone.create') !!}" class="sidebar-link">
                                        <i class="mdi mdi-octagram"></i>
                                        <span class="hide-menu">New Milestone</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="{!! route('milestone.index') !!}" class="sidebar-link">
                                        <i class="mdi mdi-octagram"></i>
                                        <span class="hide-menu">Show all Milestones</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="sidebar-item">
                            ...
                            <ul class="collapse second-level" aria-expanded="false">
                                <li class="sidebar-item">
                                    <a href="{!! route('tool.create') !!}" class="sidebar-link">
                                        <i class="mdi mdi-octagram"></i>
                                        <span class="hide-menu">New Tools</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="{!! route('tool.index') !!}" class="sidebar-link">
                                        <i class="mdi mdi-octagram"></i>
                                        <span class="hide-menu">Show all Tools</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="sidebar-item">
                            <a href="javascript:void(0)" class="sidebar-link has-arrow">
                                <i class="icon-Record"></i>
                                <span class="hide-menu">Knowledgebase</span>
                            </a>
                            <ul class="collapse second-level" aria-expanded="false">
                                <li class="sidebar-item">
                                    <a href="{!! route('knowledge.create') !!}" class="sidebar-link">
                                        <i class="mdi mdi-octagram"></i>
                                        <span class="hide-menu">New Knowledgebase</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="{!! route('knowledge.index') !!}" class="sidebar-link">
                                        <i class="mdi mdi-octagram"></i>
                                        <span class="hide-menu">Show all Knowledgebases</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-item">
                            <a href="config" class="sidebar-link">
                                <i class="icon-Record"></i>
                                <span class="hide-menu">Configs</span>
                            </a>
                        </li>
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        ...
                        <li class="sidebar-item">
                            <a href="icon-iconmind.html" class="sidebar-link">
                                <i class="mdi mdi mdi-image-broken-variant"></i>
